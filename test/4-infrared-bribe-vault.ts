...
import { 
  RedeemPool__factory, PTokenV2__factory,
...
describe('Infrared Bribe Vault', () => {
  ...
  it('Bribe Vault basic E2E works', async () => {
    ...
    const piBGT = PTokenV2__factory.connect(await vault.pToken(), ethers.provider);
    ...
    await expect(trans)
      .to.emit(piBGT, "Rebased").withArgs(netSwapAmount, anyValue)
  ...
  it('Bribe Vault with assets with 8 decimals basic E2E works', async () => {
    ...
    const piBGT = PTokenV2__factory.connect(await vault8.pToken(), ethers.provider);
  ...
  it('Bribe Vault with assets with 28 decimals basic E2E works', async () => {
    ...
    const piBGT = PTokenV2__factory.connect(await vault28.pToken(), ethers.provider);
  ...
  it('Swap works', async () => {
    ...
    await expect(trans)
      .to.emit(piBGT, "Rebased").withArgs(swapAssetAmount, anyValue)
