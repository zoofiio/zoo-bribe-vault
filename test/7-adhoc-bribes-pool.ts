...
describe('AdhocBribesPool', () => {
  ...
  it('AdhocBribesPool Time Weighted YT Works', async () => {
    ...
    const epochEndTimestamp = await bribesPool.epochEndTimestamp();
    ...
    expect(await bribesPool.maxTotalSupply()).to.equal((epochEndTimestamp - lastTimestamp1) * bobYTAmount);
